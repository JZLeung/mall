...
<html lang="zh-cn">
	...
	<head>
		...
		<!--
        	...
        	描述：使用官网CSS/JS同步最新版
        -->
		<link rel="stylesheet" href="/mall/Public/Admin/pintu/css/pintuer.css">
		<link rel="stylesheet" href="/mall/Public/Admin/pintu/css/admin.css">
		<script src="/mall/Public/Common/js/jquery-1.12.0.js"></script>
		<script src="/mall/Public/Admin/pintu/js/pintuer.js"></script>
		<script src="/mall/Public/Admin/pintu/js/respond.js"></script>
		<script src="/mall/Public/Admin/pintu/js/admin.js"></script>
	...
	<body>
		<div class="lefter">
			<div class="logo">
				<a href="http://www.pintuer.com" target="_blank"><img src="/mall/Public/Admin/pintu/images/logo.png" alt="后台管理系统" /></a>
			</div>
		</div>
		<div class="righter nav-navicon" id="admin-nav">
			<div class="mainer">
				<div class="admin-navbar">
                    ...
                    <a class="button button-little bg-main" href="/mall" target="_blank">前台首页</a>
					...
					<ul class="nav nav-inline admin-nav">
						<li class="active">
							...
							<ul>
								<li class="active"><a href="system.html">系统设置</a></li>
				...
				<div class="xm3">
					<div class="panel border-back">
						<div class="panel-body text-center">
							<img src="/mall/Public/Admin/pintu/images/face.jpg" width="120" class="radius-circle" />
							<br /> admin
						</div>
